...
/*   Updated: 2025/12/04 23:13:39 by yannis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// nitems number of element to be allocated and measure is the size of each element
...
// (size_t)-1 is the Max Value of any unsigned type because C guarantees that casting a negative int (-1) to an unsigned type results in the maximum representable value for that type
